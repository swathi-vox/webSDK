...
(function(window) {
    ...
    function arrSubscriberFunction(i) {
        ...
        document.getElementById('videoEelementName' + (i + 1)).innerHTML = (subscribeArr[i].remoteUser);
    ...
    Call.prototype.muteConference = function(callId, bool, cb) {
        ...
        if (bool) {
            ...
            wr_set_local_mute_conference(this, callId, cb);
    ...
    var loadProto = function(obj) {
        // const protoFile = "/res/iml.json";
        const protoFile = "https://tringydemo.jadukusaderjuwanene.info/neox/res/iml.json";

        // const protoFile = "http://18.188.6.91/neox/res/iml.json";
    ...
    CS.prototype.initialize = function(config, cb) {
        ...
        window.CS.rtcservers.stun = 'stun:18.188.6.91:19302';
        ...
        window.CS.appId = '';
        window.CS.jsonPath = '/res/iml.json';
