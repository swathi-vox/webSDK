...
function uuidv4() {
  ...
  Call.prototype.sendIce = function (remoteUser, ice,  jsoncandidates, callId, cb) {
    ...
    if(window.CS.call.callObj[callId].type == "IP") {
      ...
      if(window.CS.call.callObj[callId].direction == "IN"){
        ...
        send_msg(this.super, false, this.super.proto_msgType.values.E_SEND_ICE_CANDIDATES_IN_CALL_RQT, payload);
      }     
    }
  };
  ...
  var loadProto = function (obj){
    protobuf.load("/res/iml.json", function(err, root) {
      ...
      obj.callEventCode = {187:{code:"ANSWERED", phrase:"PSTN Call offer received"}, 
